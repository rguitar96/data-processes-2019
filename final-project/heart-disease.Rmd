...
# Training
knn.model <- train(target ~ ., data = train.data, trControl = control, metric = "Accuracy", method = "knn", tuneGrid = expand.grid(k = 1:15))
knn.model

#Testing
knn.pred <- predict(knn.model,test.data)

#Confusion matrix
confusionMatrix(test.data$target, knn.pred, positive = "1")
